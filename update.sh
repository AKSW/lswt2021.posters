...
for dir in _data/poster/*; do
  dirname=$(basename $dir)
  ERROR=$( { pdftocairo -png -scale-to 2000 -singlefile $dir/${dirname}.pdf img/${dirname}_s.png; } 2>&1 )
  LOG="${LOG}${ERROR}\n"
  ERROR=$( { pdftocairo -png -scale-to 3000 -singlefile $dir/${dirname}.pdf img/${dirname}_l.png; } 2>&1 )
  LOG="${LOG}${ERROR}\n"
done
